...
public class GUI extends JFrame
{
  ...
  public GUI(Player player, LinkedList<PlayerSpritzer> playerSpritzers,
          LinkedList<Enemy> enemys, LinkedList<EnemySpritzer> enemySpritzers,
          Background bg, LinkedList<Item> items)
  {
    this.player = player;
  ...
  private void draw(Graphics2D g)
  {
    ...
    for (EnemySpritzer enemySpritzer : enemySpritzers)
    {
      g.drawImage(enemySpritzer.getLook(), enemySpritzer.getBounding().x,
              enemySpritzer.getBounding().y, null);
    }
